...
export const Header = () => {
  ...
  return (
      ...
      <header
        style={{ width: "100%" }}
        className=" w-[100%] h-[7rem]  border-b border-gray-300 bg-white shadow-md flex justify-between items-center"
      >
        <div className="w-44 h-40 py-14 ml-8">
          <img
        ...
        <div>
          <p
            ...
            style={{ color: "#7BAD77", fontSize: "18px", fontWeight: "bold" }}
          >
            {currentDateTime}
          </p>
       ...
       <div className="flex"> 
        <div>
          ...
          <h5 className="ml-4" style={{ fontSize: "18px", fontWeight: "bold" }}>
            g700343
          </h5>
        </div>

        <div className="w-16 h-16 mr-8 mt-4">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTNuhnMCA2S7u_q6YKfsWFofBEcucmscNH8qQ&usqp=CAU"   className="rounded-full" alt="" />
        </div>
        </div>
      </header>
