    ...
    <div>
      ...
      <div className="flex flex-col w-[80%] h-full m-auto mt-24">
        <div className="flex  ">
          ...
          <input
            className="bg-gray-300 w-[16rem] ml-4 h-10 px-4 text-black"
            type="text"
        ...
        <div className="flex  mt-12">
          <span>Email</span>
          <input
            className="bg-gray-300 w-[16rem] ml-14 h-10 px-4 text-black"
            type="email"
            placeholder="Email"
          />
          <span className="ml-12">Password</span>
          <input
            className="bg-gray-300 w-[16rem] ml-8 h-10 px-4 text-black"
            type="password"
        ...
        <div className="flex mt-12">
          ...
          <input
            className="bg-gray-300 w-[16rem] ml-7 h-10 px-4 text-black"
            type="text"
        ...
        <button className="w-48 bg-primary h-14 text-black mt-12 ml-[20rem] ">
          Create account
        </button>
      </div>
    </div>
