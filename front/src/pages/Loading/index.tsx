export const Loading = () => {
  ...
  return (
    <div>
      ...
      <footer
        class="bg-gray-100 rounded-lg shadow dark:bg-gray-900 mt-12 w-full"
        style={{ height: "15rem" }}
      >
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="flex flex-wrap items-center mb-6  font-medium text-gray-500 sm:mb-0 dark:text-gray-400 mr-12">
              <li>
          ...
          <span class="block   sm:text-center " style={{ color: "#7BAD77" }}>
